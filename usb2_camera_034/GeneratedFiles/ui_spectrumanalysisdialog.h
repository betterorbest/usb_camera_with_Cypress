...
public:
    ...
    void setupUi(QDialog *m_spectrumAnalysisDialogClass)
    {
        ...
        m_spectrumAnalysisDialogClass->resize(1459, 813);
        ...
        m_showLabel->setGeometry(QRect(30, 150, 640, 480));
        ...
        m_plot->setGeometry(QRect(700, 150, 731, 541));
        ...
        m_loadImagesButton->setGeometry(QRect(60, 30, 93, 28));
        ...
        m_listImg->setGeometry(QRect(40, 680, 491, 61));
        ...
        m_clearCurvesButton->setGeometry(QRect(740, 30, 93, 28));
    ...
    void retranslateUi(QDialog *m_spectrumAnalysisDialogClass)
    {
        ...
        m_showLabel->setText(QApplication::translate("m_spectrumAnalysisDialogClass", "\346\230\276\347\244\272", 0));
